...
class Invoice implements \JsonSerializable
{
    ...
    public function authorize($source, $options = array())
    {
        ...
        // Handling for field 
        $body = $response->getBody();
        $invoicesAuthorizeResponse = new InvoicesAuthorizeResponse($this->client);
        $returnValues['invoicesAuthorizeResponse'] = $invoicesAuthorizeResponse->fillWithData($body);
    ...
    public function capture($source, $options = array())
    {
        ...
        // Handling for field 
        $body = $response->getBody();
        $invoicesCaptureResponse = new InvoicesCaptureResponse($this->client);
        $returnValues['invoicesCaptureResponse'] = $invoicesCaptureResponse->fillWithData($body);
